...
export const Signup = (email, password) => {
    return async dispatch => {
        const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key= AIzaSyBRVBmyHm8gQ0X59CCm73ZTUwRBpCA1bm4',
            {
                method: 'POST',
                headers: {
...
export const Login = (email, password) => {
    return async dispatch => {
        const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key= AIzaSyBRVBmyHm8gQ0X59CCm73ZTUwRBpCA1bm4',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
